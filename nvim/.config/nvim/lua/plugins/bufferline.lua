...
local function _1_(...)
  ...
  local function _1_()
    return {require("aniseed.core"), require("bufferline"), require("colors"), require("aniseed.fennel"), require("aniseed.nvim"), require("utils")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "aniseed.core", bufferline = "bufferline", colors = "colors", fennel = "aniseed.fennel", nvim = "aniseed.nvim", utils = "utils"}}
    return val_0_
  else
    return print(val_0_)
  end
