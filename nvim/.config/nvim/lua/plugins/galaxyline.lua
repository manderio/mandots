...
local function _1_(...)
  ...
  local function _1_()
    return {require("aniseed.core"), require("colors"), require("aniseed.fennel"), require("galaxyline"), require("galaxyline.condition"), require("galaxyline.provider_diagnostic"), require("galaxyline.provider_fileinfo"), require("galaxyline.provider_vcs"), require("aniseed.nvim"), require("utils")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {["require-macros"] = {macros = true}, require = {["gl-condition"] = "galaxyline.condition", ["gl-diagnostic"] = "galaxyline.provider_diagnostic", ["gl-fileinfo"] = "galaxyline.provider_fileinfo", ["gl-vcs"] = "galaxyline.provider_vcs", a = "aniseed.core", colors = "colors", fennel = "aniseed.fennel", galaxyline = "galaxyline", nvim = "aniseed.nvim", utils = "utils"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local galaxyline = _local_0_[4]
local gl_condition = _local_0_[5]
local gl_diagnostic = _local_0_[6]
local gl_fileinfo = _local_0_[7]
local gl_vcs = _local_0_[8]
...
local function buf_name_empty_3f()
  return a["empty?"](nvim.fn.expand("%:t"))
end
